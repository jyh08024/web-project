<?php require "view/header.php" ?>
    ...
    <div class="section event_enr_section wrap">
      <div class="section_title">
        <p class="main_title">이벤트 수정/삭제<span class="color">페이지</span></p>
        <p>이벤트를 수정/삭제하는 페이지입니다.</p>
      </div>
      ...
      <div class="event_enr flex alc jc">
        <form class="event_enr_form">
          ...
          <div class="btn_area">
            <button class="btn event_enr" type="button" name="postType" value="update" onclick="ajax(`../app/eventEnr.php`, ``, `event_enr_form`, `수정이 완료되었습니다.`, this)">이벤트 수정</button>
            <button class="btn event_enr" type="button" name="postType" value="delete" onclick="ajax(`../app/eventEnr.php`, ``, `event_enr_form`, `삭제가 완료되었습니다.`, this)">이벤트 삭제</button>
          </div>
        </form>
      </div>
    </div>
